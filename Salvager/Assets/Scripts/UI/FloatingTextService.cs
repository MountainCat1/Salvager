...
{
  [Tooltip("The prefab used for displaying floating text.")]
  [SerializeField]
  private TextMeshProUGUI floatingTextPrefab;

  [Tooltip("The canvas to which the floating text will be added.")]
  [SerializeField]
  ...
  [Tooltip("The duration for which the text is visible.")]
  [SerializeField]
